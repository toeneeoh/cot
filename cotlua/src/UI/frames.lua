...
OnInit.final("Frames", function(Require)
    Require('Button') --use for button generation
    Require('Events')
    ...
    --currency frames
    do
        CONVERTER_FRAME = BlzCreateFrame("QuestButtonDisabledBackdropTemplate", RESOURCE_BAR, 0, 0)
        ...
        --plat/arc frames
        PLAT_FRAME = BlzCreateFrameByType("FRAME", "", CONVERTER_FRAME, "", 0)
        BlzFrameSetTexture(PLAT_FRAME, "trans32.blp", 0, true)
        ...
        ARC_FRAME = BlzCreateFrameByType("FRAME", "", CONVERTER_FRAME, "", 0)
        BlzFrameSetTexture(ARC_FRAME, "trans32.blp", 0, true)
        ...
        --plat text
        PLAT_TEXT = BlzCreateFrameByType("TEXT", "", CONVERTER_FRAME, "CText_18", 0)
        ...
        --arcadite text
        ARC_TEXT = BlzCreateFrameByType("TEXT", "", CONVERTER_FRAME, "CText_18", 0)
        ...
        FrameAddSimpleTooltip(PLAT_FRAME, "Platinum Coin", "Obtained by supplying 1,000,000 gold at a trader or with a converter.", false)
        FrameAddSimpleTooltip(ARC_FRAME, "Arcadite Lumber", "Obtained by supplying 1,000,000 lumber at a trader or with a converter.", false)
    end
