OnInit.map("Preloader", function()
    ...
    RemoveUnit(CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), SUMMON_HOUND, 30000., 30000., 0.))
    RemoveUnit(CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), SUMMON_GOLEM, 30000., 30000., 0.))
    RemoveUnit(CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), SUMMON_DESTROYER, 30000., 30000., 0.))
